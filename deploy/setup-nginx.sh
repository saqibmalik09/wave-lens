...
echo "Nginx OK."
echo ""
echo "IMPORTANT — SSL (if certs are missing):"
echo "  bash deploy/sync-nginx.sh"
echo "  # or manually:"
...
echo ""
echo "Verify marketing site (must NOT return NestJS JSON 404):"
echo "  curl -I https://wavelens.online/"
echo ""
echo "Test API:"
